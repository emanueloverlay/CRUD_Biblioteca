...
const apiUrl = 'http://localhost/crud_biblioteca/app/controllers/BookController.php';
const updateUrl = 'http://localhost/crud_biblioteca/public/views/updateBook.php';
